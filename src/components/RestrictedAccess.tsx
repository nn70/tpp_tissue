            ...
            <div className="bg-white/5 border border-white/10 rounded-3xl p-8 max-w-md w-full text-center space-y-4 shadow-xl">
                <div className="flex justify-center mb-6">
                    <div className="bg-amber-500/20 p-4 rounded-full">
                        <ShieldAlert className="w-12 h-12 text-[#61C5C7]" />
                    </div>
                </div>
                ...
                <div className="pt-6">
                    <Link
                        href="/login"
                        className="inline-flex items-center justify-center space-x-2 tpp-primary-button text-white px-8 py-3 rounded-xl font-medium shadow-lg shadow-[#61C5C7]/20 transition-all hover:scale-105 active:scale-95"
                    >
